...
def main():
    ...
    # 设置根目录
    root_folder = "/root/autodl-tmp/RAG_Agent_vllm_tzh/src/experiment/processed_pdf/4-42/Base"
    ...
    output_dir = "/root/autodl-tmp/RAG_Agent_vllm_tzh/src/experiment/pipeline"
